...
#define evaluate_for_each_inside(f, ...) __VA_OPT__(evaluate_for_each_at_least_one(f, __VA_ARGS__))
#define evaluate_for_each_at_least_one(f, a, ...) f a defer_macro_once(evaluate_for_each_again)()(f, __VA_ARGS__)
...
#define evaluate_for_each_comma_inside(f, ...) __VA_OPT__(evaluate_for_each_comma_at_least_one(f, __VA_ARGS__))
#define evaluate_for_each_comma_starting_inside(f, ...) __VA_OPT__(, evaluate_for_each_comma_at_least_one(f, __VA_ARGS__))
#define evaluate_for_each_comma_at_least_one(f, a, ...) f a defer_macro_once(evaluate_for_each_comma_starting)()(f, __VA_ARGS__)
...
#define evaluate_for_each_brackets_inside(f, ...) __VA_OPT__(evaluate_for_each_brackets_at_least_one(f, __VA_ARGS__))
#define evaluate_for_each_brackets_at_least_one(f, a, ...) f(a) defer_macro_once(evaluate_for_each_brackets_again)()(f, __VA_ARGS__)
