...
inline decltype(auto) flat_timeshard_field_key_rehydrate(flat_timeshard_field_comparer &comparer, key_type const &k) { return k; }
...
struct flat_timeshard_index_field {
    ...
    void flat_timeshard_ensure_field_mmapped(uint64_t index) { field_hash.hash_mmap.mmap_allocate_at_least(1); }
    template<typename lookup_type>
    [[nodiscard]] uint64_t *flat_timeshard_index_lookup_key(lookup_type &&k) const { return field_hash.hash_find_key(k); }
